...
var textoSaga1 = `A saga começa com um flashback da execução de Gol D. Roger. Antes de morrer, ele diz as multidões para saírem e procurarem o seu tesouro. Isso provocou a Era de Ouro da Pirataria em que incontáveis piratas levantaram suas bandeiras e partiram para encontrar o One Piece.
<br>
Essa saga se concentra principalmente em Luffy sair para a Grand Line e recrutando tripulantes. Durante a saga, Luffy ganha quatro companheiros: Zoro, Nami, Usopp e Sanji e ganha uma recompensa de berries30,000,000 pela sua cabeça. .`;


var textoSaga2 = `Os Chapéus de Palha finalmente entram na Grand Line, eles conhecem Nefertari Vivi e decidem ajudar a salvar seu país, Alabasta.<br> Através da Grand Line, eles afastam as tentativas de assassinato da Baroque Works enquanto conhecem o irmão mais velho de Luffy, Portgas D. Ace, bem como dois gigantes chamados Dorry e Brogy, e ganham um novo membro na tripulação: Tony Tony Chopper.A saga atinge o clímax em um confronto total com os Chapéus de Palha que lutam contra a Baroque Works e seu líder, o Mr. 0, também conhecido como Crocodile, um Shichibukai. Depois que a organização é derrotada, o Governo Mundial aumenta a recompensa de Luffy para 100.000.000 berries  e Zoro ganha uma recompensa de 60.000.000 berries .`;
...
var saga = [
    ...
    {
        class: " HomensPeixe",
        img: "SagaHomensPeixes.jfif",
        nome: "Ilha dos Homens Peixes",
        texto: textoSaga7,
        href:"#",
    },
    {
        class: " AliancaPirata",
        img: "AliancaPirataSaga.jpg",
        nome: "Aliança Pirata",
        texto: textoSaga8,
        href: "#",
    },
...
for (var cont = 0; cont < saga.length; cont++) {
    ...
    <div class="caixaSaga">
      ...
      <div class="imagemConteudo"> <img src="assets/img/sagas/${saga[cont].img}" alt=""></div>
       ...
       <div class="textoConteudo">
        ...
        <h1>${saga[cont].nome}</h1>
         <p>${saga[cont].texto}</p>
         <a href="${saga[cont].href}">Ver Mais...</a>
